...
{  
  ...
  # B matrix definition
  initial$B.matrix[1:4,1:4] <- less.input * initial$A.matrix[1:4,1:4]
  initial$B.matrix[5,1:4] <- more.input * initial$A.matrix[5,1:4]
  initial$B.matrix[6 : 9,1:4] <- less.input * initial$A.matrix[6:9,1:4]
...
for (iter in 1:500){
  ...
  Z1_mu[1,] = (1 - (Z1_w[1]/Z1_pr[1,]))/((                  1*a11 + Z1_p[2,]*a21 + Z1_p[3,]*a31 + Z1_p[4,]*a41 + Z1_p[5,]*a51 +
                                                              Z2_xr[,]*(Z2_p[6,]*a61 + Z2_p[7,]*a71 + Z2_p[8,]*a81 + Z2_p[9,]*a91 + Z2_p[10,]*a101) )*(1 + Z1_kappa[1,] * Z1_delta)) - 1/(1 + Z1_kappa[1,] * Z1_delta)
  Z1_mu[2,] = (1 - (Z1_w[2,]/Z1_pr[2,]))/((           Z1_p[1,]*a12 + 1*a22        + Z1_p[3,]*a32 + Z1_p[4,]*a42 + Z1_p[5,]*a52 +
                                                        Z2_xr[,]*(Z2_p[6,]*a62 + Z2_p[7,]*a72 + Z2_p[8,]*a82 + Z2_p[9,]*a92 + Z2_p[10,]*a102) )*(1 + Z1_kappa[2,] * Z1_delta)) - 1/(1 + Z1_kappa[2,] * Z1_delta)
  Z1_mu[3,] = (1 - (Z1_w[3,]/Z1_pr[3,]))/((           Z1_p[1,]*a13 + Z1_p[2,]*a23 + 1*a33        + Z1_p[4,]*a43 + Z1_p[5,]*a53 +
                                                        Z2_xr[,]*(Z2_p[6,]*a63 + Z2_p[7,]*a73 + Z2_p[8,]*a83 + Z2_p[9,]*a93 + Z2_p[10,]*a103) )*(1 + Z1_kappa[3,] * Z1_delta)) - 1/(1 + Z1_kappa[3,] * Z1_delta)
  Z1_mu[4,] = (1 - (Z1_w[4,]/Z1_pr[4,]))/((           Z1_p[1,]*a14 + Z1_p[2,]*a24 + Z1_p[3,]*a34 + 1*a44        + Z1_p[5,]*a54 +
                                                        Z2_xr[,]*(Z2_p[6,]*a64 + Z2_p[7,]*a74 + Z2_p[8,]*a84 + Z2_p[9,]*a94 + Z2_p[10,]*a104) )*(1 + Z1_kappa[4,] * Z1_delta)) - 1/(1 + Z1_kappa[4,] * Z1_delta) 
  Z1_mu[5,] = (1 - (Z1_w[5,]/Z1_pr[5,]))/((           Z1_p[1,]*a15 + Z1_p[2,]*a25 + Z1_p[3,]*a35 + Z1_p[4,]*a45        + 1*a55 +
                                                        Z2_xr[,]*(Z2_p[6,]*a65 + Z2_p[7,]*a75 + Z2_p[8,]*a85 + Z2_p[9,]*a95 + Z2_p[10,]*a105) )*(1 + Z1_kappa[5,] * Z1_delta)) - 1/(1 + Z1_kappa[5,] * Z1_delta) 
  
  
  
  Z1_p[1,]  =  ((                          Z1_p[2,]*a21 + Z1_p[3,]*a31 + Z1_p[4,]*a41 + Z1_p[5,]*a51 +
                                             Z2_xr[,]*(Z2_p[6,]*a61 + Z2_p[7,]*a71 + Z2_p[8,]*a81 + Z2_p[9,]*a91 + Z2_p[10,]*a101) )*(1 + Z1_kappa[1,] * Z1_delta) * (1+Z1_mu[1,]) + Z1_w[1,]/Z1_pr[1,]) /(1 - a11 * (1+Z1_mu[1,]))
  Z1_p[2,]  =  ((           Z1_p[1,]*a12                + Z1_p[3,]*a32 + Z1_p[4,]*a42 + Z1_p[5,]*a52 + 
                              Z2_xr[,]*(Z2_p[6,]*a62 + Z2_p[7,]*a72 + Z2_p[8,]*a82 + Z2_p[9,]*a92 + Z2_p[10,]*a102) )*(1 + Z1_kappa[2,] * Z1_delta) * (1+Z1_mu[2,]) + Z1_w[2,]/Z1_pr[2,]) /(1 - a22 * (1+Z1_mu[2,]))
  Z1_p[3,]  =  ((           Z1_p[1,]*a13 + Z1_p[2,]*a23                + Z1_p[4,]*a43 + Z1_p[5,]*a53 + 
                              Z2_xr[,]*(Z2_p[6,]*a63 + Z2_p[7,]*a73 + Z2_p[8,]*a83 + Z2_p[9,]*a93 + Z2_p[10,]*a103) )*(1 + Z1_kappa[3,] * Z1_delta) * (1+Z1_mu[3,]) + Z1_w[3,]/Z1_pr[3,]) /(1 - a33 * (1+Z1_mu[3,]))
  Z1_p[4,]  =  ((           Z1_p[1,]*a14 + Z1_p[2,]*a24 + Z1_p[3,]*a34 +              + Z1_p[5,]*a54 +
                              Z2_xr[,]*(Z2_p[6,]*a64 + Z2_p[7,]*a74 + Z2_p[8,]*a84 + Z2_p[9,]*a94 + Z2_p[10,]*a104) )*(1 + Z1_kappa[4,] * Z1_delta) * (1+Z1_mu[4,]) + Z1_w[4,]/Z1_pr[4,]) /(1 - a44 * (1+Z1_mu[4,]))
  Z1_p[5,]  =  ((           Z1_p[1,]*a15 + Z1_p[2,]*a25 + Z1_p[3,]*a35 + Z1_p[4,]*a45+               +
                              Z2_xr[,]*(Z2_p[6,]*a65 + Z2_p[7,]*a75 + Z2_p[8,]*a85 + Z2_p[9,]*a95 + Z2_p[10,]*a105) )*(1 + Z1_kappa[5,] * Z1_delta) * (1+Z1_mu[5,]) + Z1_w[5,]/Z1_pr[5,]) /(1 - a55 * (1+Z1_mu[5,]))
  
  
  
  Z2_mu[6,] = (1 - (Z2_w[6,]/Z2_pr[6,]))/((                  1*a66 + Z2_p[7,]*a76 + Z2_p[8,]*a86 + Z2_p[9,]*a96 + Z2_p[10,]*a106 +
                                                               Z1_xr[,]*(Z1_p[1,]*a16 + Z1_p[2,]*a26 + Z1_p[3,]*a36 + Z1_p[4,]*a46 + Z1_p[5,]*a56) )*(1 + Z2_kappa[6,] * Z2_delta)) - 1/(1 + Z2_kappa[6,] * Z2_delta)
  Z2_mu[7,] = (1 - (Z2_w[7,]/Z2_pr[7,]))/((           Z2_p[6,]*a67 + 1*a77        + Z2_p[8,]*a87 + Z2_p[9,]*a97 + Z2_p[10,]*a107 +
                                                        Z1_xr[,]*(Z1_p[1,]*a17 + Z1_p[2,]*a27 + Z1_p[3,]*a37 + Z1_p[4,]*a47 + Z1_p[5,]*a57) )*(1 + Z2_kappa[7,] * Z2_delta)) - 1/(1 + Z2_kappa[7,] * Z2_delta)
  Z2_mu[8,] = (1 - (Z2_w[8,]/Z2_pr[8,]))/((           Z2_p[6,]*a68 + Z2_p[7,]*a78 + 1*a88        + Z2_p[9,]*a98 + Z2_p[10,]*a108 +
                                                        Z1_xr[,]*(Z1_p[1,]*a18 + Z1_p[2,]*a28 + Z1_p[3,]*a38 + Z1_p[4,]*a48 + Z1_p[5,]*a58) )*(1 + Z2_kappa[8,] * Z2_delta)) - 1/(1 + Z2_kappa[8,] * Z2_delta)
  Z2_mu[9,] = (1 - (Z2_w[9,]/Z2_pr[9,]))/((           Z2_p[6,]*a69 + Z2_p[7,]*a79 + Z2_p[8,]*a89 + 1*a99        + Z2_p[10,]*a109 +
                                                        Z1_xr[,]*(Z1_p[1,]*a19 + Z1_p[2,]*a29 + Z1_p[3,]*a39 + Z1_p[4,]*a49 + Z1_p[5,]*a59) )*(1 + Z2_kappa[9,] * Z2_delta)) - 1/(1 + Z2_kappa[9,] * Z2_delta)
  Z2_mu[10,] = (1 - (Z2_w[10,]/Z2_pr[10,]))/((           Z2_p[6,]*a610 + Z2_p[7,]*a710 + Z2_p[8,]*a810 + Z2_p[9,]*a910        + 1*a1010 +
                                                           Z1_xr[,]*(Z1_p[1,]*a110 + Z1_p[2,]*a210 + Z1_p[3,]*a310 + Z1_p[4,]*a410 + Z1_p[5,]*a510) )*(1 + Z2_kappa[10,] * Z2_delta)) - 1/(1 + Z2_kappa[10,] * Z2_delta)
  
  
  Z2_p[6,]  =  ((                        + Z2_p[7,]*a76 + Z2_p[8,]*a86 + Z2_p[9,]*a96 + Z2_p[10,]*a106 +
                                           Z1_xr[,]*(Z1_p[1,]*a16 + Z1_p[2,]*a26 + Z1_p[3,]*a36 + Z1_p[4,]*a46 + Z1_p[5,]*a56) )*(1 + Z2_kappa[6,] * Z2_delta) * (1+Z2_mu[6,]) + Z2_w[6,]/Z2_pr[6,]) /(1 - a66 * (1+Z2_mu[6,]))
  Z2_p[7,]  =  ((         Z2_p[6,]*a67 +              + Z2_p[8,]*a87 + Z2_p[9,]*a97 + Z2_p[10,]*a107 +
                            Z1_xr[,]*(Z1_p[1,]*a17 + Z1_p[2,]*a27 + Z1_p[3,]*a37 + Z1_p[4,]*a47 + Z1_p[5,]*a57) )*(1 + Z2_kappa[7,] * Z2_delta) * (1+Z2_mu[7,]) + Z2_w[7,]/Z2_pr[7,]) /(1 - a77 * (1+Z2_mu[7,]))
  Z2_p[8,]  = ((           Z2_p[6,]*a68 + Z2_p[7,]*a78 +               + Z2_p[9,]*a98 + Z2_p[10,]*a108 +
                             Z1_xr[,]*(Z1_p[1,]*a18 + Z1_p[2,]*a28 + Z1_p[3,]*a38 + Z1_p[4,]*a48 + Z1_p[5,]*a58) )*(1 + Z2_kappa[8,] * Z2_delta) * (1+Z2_mu[8,]) + Z2_w[8,]/Z2_pr[8,]) /(1 - a88 * (1+Z2_mu[8,]))
  Z2_p[9,]  = ((           Z2_p[6,]*a69 + Z2_p[7,]*a79 + Z2_p[8,]*a89 +               + Z2_p[10,]*a109 +
                             Z1_xr[,]*(Z1_p[1,]*a19 + Z1_p[2,]*a29 + Z1_p[3,]*a39 + Z1_p[4,]*a49 + Z1_p[5,]*a59) )*(1 + Z2_kappa[9,] * Z2_delta) * (1+Z2_mu[9,]) + Z2_w[9,]/Z2_pr[9,]) /(1 - a99 * (1+Z2_mu[9,]))
  Z2_p[10,]  =  ((         Z2_p[6,]*a610 + Z2_p[7,]*a710 + Z2_p[8,]*a810 +Z2_p[9,]*a910+               +  
                             Z1_xr[,]*(Z1_p[1,]*a110 + Z1_p[2,]*a210 + Z1_p[3,]*a310 + Z1_p[4,]*a410 + Z1_p[5,]*a510) )*(1 + Z2_kappa[9,] * Z2_delta) * (1+Z2_mu[9,]) + Z2_w[9,]/Z2_pr[9,]) /(1 - a99 * (1+Z2_mu[9,]))
...
#CREATE AND RUN THE MODEL
    ...
    for (iterations in 1 : max.iterations) {
      ...
      #HOUSEHOLDS
        ...
        if(Z1_va[,i]>0){
          ...
          Z1_ineq[,i] = abs(1 - Z1_ydw[,i] / Z1_ydc[,i])
          Z1_ineq_j[,i] = abs(1 - Z1_ydw_j[,i] / Z1_ydc_j[,i])
        }
      ...
      #PRODUCTION FIRMS
        ...
        Z1_d[,i] = Z1_beta[,i]*Z1_c[,i] + Z1_sigma[,i]*Z1_g[,i] + Z1_iota[,i]*Z1_id[,i]+ Z1_iota[,i]*Z1_id_g[,i] + Z2_eta_rev[,i]*Z1_rex[,i] - Z1_eta[,i]*Z1_imp[,i] 
        ...
        Z1_yn[,i] = Z1_c[,i]*Z1_pa[,i] + Z1_id[,i]*Z1_pid[,i] +Z1_id_g[,i]*Z1_pid[,i] + Z1_g[,i]*Z1_pg[,i] + Z1_nex[,i] - Z1_nimp[,i] - Z1_vat_rev[,i] - Z2_xr[,i]*Z2_tar_rev[,i]
        ...
        if(i<=3){Z1_kt[,i] = 0}
        else{Z1_kt[,i] = (t(Z1_p[,i-1]) %*% (Z1_kappa[,i] * (Z1_x[,i-1]+Z2_x[,i-1]))) / Z1_pid[,i-1]}
      ...
      #GOVERNMENT AND CENTRAL BANK
        ...
        #Z1_g[,i]= Z1_g[,i-1]*(1 + Z1_g_g*(0.8 - Z1_b_s[,i-1]/Z1_va[,i-1])) + Z1_g0[,i]
        #if(i<=5){Z1_g[,i]= Z1_g[,i-1] + Z1_g0[,i]}
        #else{Z1_g[,i]= Z1_g_g*(0.8*Z1_va[,i-1] - Z1_b_s[,i-1]) + Z1_g[,i-1]}
        
        #if(i<=3){Z1_g[,i]= Z1_g[,i-1] + Z1_g0[,i]}
        #else{Z1_g[,i]= (Z1_g_g*(0.8*Z1_va[,i-1] - Z1_b_s[,i-1])
          #+ Z1_t[,i-1] - Z1_rb[,i-1] * Z1_b_s[,i-1] + Z1_f_cb[,i-1] + Z1_vat_rev[,i-1] + Z1_tar_rev[,i-1])/Z1_pg[,i-1]}
        ...
        Z1_id_g[,i] = Z1_da_g[,i] + Z1_id0[,i]
        #Z1_id[,i] = Z1_gamma*(Z1_kt[,i] - Z1_k[,i-1]) + Z1_da[,i] + Z1_id0[,i]
        
        #Government Depreciation allowances in real terms 
        Z1_da_g[,i] = Z1_delta_g * Z1_k_g[,i-1]
        #Z1_da[,i] = Z1_delta * Z1_k[,i-1]
        
        #Government Fixed capital stock
        Z1_k_g[,i] = Z1_k_g[,i-1] + Z1_id_g[,i] - Z1_da_g[,i]
        #Z1_k[,i] = Z1_k[,i-1] + Z1_id[,i] - Z1_da[,i]
        ...
        #Total import tariffs revenue #NEW <--- JBF
        ...
        Z1_gdef[,i] = Z1_g[,i]*Z1_pg[,i] - Z1_t[,i] + Z1_rb[,i-1] * Z1_b_s[,i-1] - Z1_f_cb[,i] - Z1_vat_rev[,i] - Z1_tar_rev[,i] +Z1_id_g[,i]*Z1_pid[,i]
      ...
      #PRICES AND PRODUCTION FUNCTION 
        ...
        Z1_p_t[1,i]  =  ((                                Z1_p_t[2,i]*a21[,i]+Z1_p_t[3,i]*a31[,i]+Z1_p_t[4,i]*a41[,i]+Z1_p_t[5,i]*a51[,i]+
                           Z2_xr[,i]*(Z2_p_t[6,i]*a61[,i]+Z2_p_t[7,i]*a71[,i]+Z2_p_t[8,i]*a81[,i]+Z2_p_t[9,i]*a91[,i]+Z2_p_t[10,i]*a101[,i]) )*(1+Z1_mu[1,i])*(1 + Z1_kappa[1,i]*Z1_delta) + Z1_w[1,i]/Z1_pr[1,i]) /(1 - a11[,i]*(1+Z1_mu[1,i]))
        
        Z1_p_t[2,i]  =  ((            Z1_p_t[1,i]*a12[,i]                    +Z1_p_t[3,i]*a32[,i]+Z1_p_t[4,i]*a42[,i]+Z1_p_t[5,i]*a52[,i]+
                           Z2_xr[,i]*(Z2_p_t[6,i]*a62[,i]+Z2_p_t[7,i]*a72[,i]+Z2_p_t[8,i]*a82[,i]+Z2_p_t[9,i]*a92[,i]+Z2_p_t[10,i]*a102[,i]) )*(1+Z1_mu[2,i])*(1 + Z1_kappa[2,i]*Z1_delta) + Z1_w[2,i]/Z1_pr[2,i]) /(1 - a22[,i]*(1+Z1_mu[2,i]))
        
        Z1_p_t[3,i]  =  ((            Z1_p_t[1,i]*a13[,i]+Z1_p_t[2,i]*a23[,i]                    +Z1_p_t[4,i]*a43[,i]+Z1_p_t[5,i]*a53[,i]+
                           Z2_xr[,i]*(Z2_p_t[6,i]*a63[,i]+Z2_p_t[7,i]*a73[,i]+Z2_p_t[8,i]*a83[,i]+Z2_p_t[9,i]*a93[,i]+Z2_p_t[10,i]*a103[,i]) )*(1+Z1_mu[3,i])*(1 + Z1_kappa[3,i]*Z1_delta) + Z1_w[3,i]/Z1_pr[3,i]) /(1 - a33[,i]*(1+Z1_mu[3,i]))
        
        Z1_p_t[4,i]  =  ((            Z1_p_t[1,i]*a14[,i]+Z1_p_t[2,i]*a24[,i]+Z1_p_t[3,i]*a34[,i]                    +Z1_p_t[5,i]*a54[,i]+                      
                           Z2_xr[,i]*(Z2_p_t[6,i]*a64[,i]+Z2_p_t[7,i]*a74[,i]+Z2_p_t[8,i]*a84[,i]+Z2_p_t[9,i]*a94[,i]+Z2_p_t[10,i]*a104[,i]) )*(1+Z1_mu[4,i])*(1 + Z1_kappa[4,i]*Z1_delta) + Z1_w[4,i]/Z1_pr[4,i]) /(1 - a44[,i]*(1+Z1_mu[4,i]))
        
        Z1_p_t[5,i]  =  ((            Z1_p_t[1,i]*a15[,i]+Z1_p_t[2,i]*a25[,i]+Z1_p_t[3,i]*a35[,i]+Z1_p_t[4,i]*a45[,i]+                      
                           Z2_xr[,i]*(Z2_p_t[6,i]*a65[,i]+Z2_p_t[7,i]*a75[,i]+Z2_p_t[8,i]*a85[,i]+Z2_p_t[9,i]*a95[,i]+Z2_p_t[10,i]*a105[,i]) )*(1+Z1_mu[5,i])*(1 + Z1_kappa[5,i]*Z1_delta) + Z1_w[5,i]/Z1_pr[5,i]) /(1 - a55[,i]*(1+Z1_mu[5,i]))
        ...
        Z1_pim[,i] = t(Z2_p[,i]) %*% Z1_eta[,i] * Z2_xr[,i]
      ...
      #AUXILIARY CALCULATIONS AND DEFINITIONS <--- JBF
        ...
        if(Z2_va[,i]>0){
          ...
          # Functional inequality
          Z2_ineq[,i] = abs(1 - Z2_ydw[,i] / Z2_ydc[,i])
          Z2_ineq_j[,i] = abs(1 - Z2_ydw_j[,i] / Z2_ydc_j[,i])
        }
        ...
        #Final demand vector in real terms# CHANGED <--- JBF (27/02/24) 
        Z2_d[,i] = Z2_beta[,i]*Z2_c[,i] + Z2_sigma[,i]*Z2_g[,i] + Z2_iota[,i]*Z2_id[,i] + Z2_iota[,i]*Z2_id_g[,i] + Z1_eta_rev[,i]*Z2_rex[,i] - Z2_eta[,i]*Z2_imp[,i] 
        ...
        #Net income (= total value added) net of VAT and tariffs #CHANGED <--- JBF (27/02/24)
        Z2_yn[,i] = Z2_c[,i]*Z2_pa[,i] + Z2_id[,i]*Z2_pid[,i] + Z2_id_g[,i]*Z2_pid[,i] + Z2_g[,i]*Z2_pg[,i] + Z2_nex[,i] - Z2_nimp[,i] - Z2_vat_rev[,i] - Z1_xr[,i]*Z1_tar_rev[,i]
        ...
        if(i<=3){Z2_kt[,i] = 0}
        else{Z2_kt[,i] = (t(Z2_p[,i-1]) %*% (Z2_kappa[,i] * (Z2_x[,i-1]+Z1_x[,i-1]))) / Z2_pid[,i-1]}
        
        #Real investment in fixed capital#CHANGED<--- JBF (27/02/24)
        ...
        #Z2_g[,i]= Z2_g[,i-1]*(1 + Z2_g_g*(0.8 - Z2_b_s[,i-1]/Z2_va[,i-1])) + Z2_g0[,i]
        
        #if(i<=5){Z2_g[,i]= Z2_g[,i-1] + Z2_g0[,i]}
        #else{Z2_g[,i]= Z2_g_g*(0.8*Z2_va[,i-1] - Z2_b_s[,i-1]) + Z2_g[,i-1]}
        
        #if(i<=3){Z2_g[,i]= Z2_g[,i-1] + Z2_g0[,i]}
        #else{Z2_g[,i]= (Z2_g_g*(0.8*Z2_va[,i-1] - Z2_b_s[,i-1])
        #                            + Z2_t[,i-1] - Z2_rb[,i-1] * Z2_b_s[,i-1] + Z2_f_cb[,i-1] + Z2_vat_rev[,i-1] + Z2_tar_rev[,i-1])/Z2_pg[,i-1]}
        
        #if(i<=10){Z2_g[,i]= Z2_g[,i-1] + Z2_g0[,i]}
        #else{Z2_g[,i]= Z2_g_g*(0.8 - Z2_b_s[,i-1]/Z1_va[,i-1])+ Z2_g[,i-1]
        
        #Government Real investment in fixed capital#NEW <--- JBF (27/02/24)
        Z2_id_g[,i] = Z2_da_g[,i] + Z2_id0[,i]
        #Z1_id[,i] = Z1_gamma*(Z1_kt[,i] - Z1_k[,i-1]) + Z1_da[,i] + Z1_id0[,i]
        
        #Government Depreciation allowances in real terms# NEW <--- JBF (27/02/24) 
        Z2_da_g[,i] = Z2_delta_g * Z2_k_g[,i-1]
        #Z1_da[,i] = Z1_delta * Z1_k[,i-1]
        
        #Government Fixed capital stock#NEW <--- JBF (27/02/24)
        Z2_k_g[,i] = Z2_k_g[,i-1] + Z2_id_g[,i] - Z2_da_g[,i]
        #Z1_k[,i] = Z1_k[,i-1] + Z1_id[,i] - Z1_da[,i]
        ...
        #Government deficit #Changed<--- JBF (27/02/24)
        Z2_gdef[,i] = Z2_g[,i]*Z2_pg[,i] - Z2_t[,i] + Z2_rb[,i-1] * Z2_b_s[,i-1] - Z2_f_cb[,i] - Z2_vat_rev[,i] - Z2_tar_rev[,i] + Z2_id_g[,i]*Z2_pid[,i]
        ...
        Z2_p_t[6,i]  =  ((                               +Z2_p_t[7,i]*a76[,i]+Z2_p_t[8,i]*a86[,i]+Z2_p_t[9,i]*a96[,i]+Z2_p_t[10,i]*a106[,i]+
                           Z1_xr[,i]*(Z1_p_t[1,i]*a16[,i]+Z1_p_t[2,i]*a26[,i]+Z1_p_t[3,i]*a36[,i]+Z1_p_t[4,i]*a46[,i]+Z1_p_t[5,i]*a56[,i])  )*(1+Z2_mu[6,i])*(1 + Z2_kappa[6,i]*Z2_delta) + Z2_w[6,i]/Z2_pr[6,i]) /(1 - a66[,i]*(1+Z2_mu[6,i]))
        
        Z2_p_t[7,i]  =  ((            Z2_p_t[6,i]*a67[,i]                    +Z2_p_t[8,i]*a87[,i]+Z2_p_t[9,i]*a97[,i]+Z2_p_t[10,i]*a107[,i]+
                           Z1_xr[,i]*(Z1_p_t[1,i]*a17[,i]+Z1_p_t[2,i]*a27[,i]+Z1_p_t[3,i]*a37[,i]+Z1_p_t[4,i]*a47[,i]+Z1_p_t[5,i]*a57[,i])  )*(1+Z2_mu[7,i])*(1 + Z2_kappa[7,i]*Z2_delta) + Z2_w[7,i]/Z2_pr[7,i]) /(1 - a77[,i]*(1+Z2_mu[7,i]))
        
        Z2_p_t[8,i]  =  ((            Z2_p_t[6,i]*a68[,i]+Z2_p_t[7,i]*a78[,i]+                   +Z2_p_t[9,i]*a98[,i]+Z2_p_t[10,i]*a108[,i]+               
                           Z1_xr[,i]*(Z1_p_t[1,i]*a18[,i]+Z1_p_t[2,i]*a28[,i]+Z1_p_t[3,i]*a38[,i]+Z1_p_t[4,i]*a48[,i]+Z1_p_t[5,i]*a58[,i])  )*(1+Z2_mu[8,i])*(1 + Z2_kappa[8,i]*Z2_delta) + Z2_w[8,i]/Z2_pr[8,i]) /(1 - a88[,i]*(1+Z2_mu[8,i]))
        
        Z2_p_t[9,i]  =  ((            Z2_p_t[6,i]*a69[,i]+Z2_p_t[7,i]*a79[,i]+Z2_p_t[8,i]*a89[,i]+                   +Z2_p_t[10,i]*a109[,i]+               
                           Z1_xr[,i]*(Z1_p_t[1,i]*a19[,i]+Z1_p_t[2,i]*a29[,i]+Z1_p_t[3,i]*a39[,i]+Z1_p_t[4,i]*a49[,i]+Z1_p_t[5,i]*a59[,i])  )*(1+Z2_mu[9,i])*(1 + Z2_kappa[9,i]*Z2_delta) + Z2_w[9,i]/Z2_pr[9,i]) /(1 - a99[,i]*(1+Z2_mu[9,i]))
        
        Z2_p_t[10,i]  =  ((            Z2_p_t[6,i]*a610[,i]+Z2_p_t[7,i]*a710[,i]+Z2_p_t[8,i]*a810[,i]+Z2_p_t[9,i]*a910[,i]+               
                           Z1_xr[,i]*(Z1_p_t[1,i]*a110[,i]+Z1_p_t[2,i]*a210[,i]+Z1_p_t[3,i]*a310[,i]+Z1_p_t[4,i]*a410[,i]+Z1_p_t[5,i]*a510[,i])  )*(1+Z2_mu[10,i])*(1 + Z2_kappa[10,i]*Z2_delta) + Z2_w[10,i]/Z2_pr[10,i]) /(1 - a1010[,i]*(1+Z2_mu[10,i]))
        ...
        Z2_pim[,i] = t(Z1_p[,i]) %*% Z2_eta[,i] * Z1_xr[,i]
        ...
        d[,i] = Z1_d[,i] + Z2_d[,i]
        Z1_fd[,i] = sum(d[1 : 5,i]) # or Z1_fd[,i]
        Z2_fd[,i] = sum(d[6 : 10,i]) # or Z2_fd[,i]
  ...
  if (length(target.variables) > 1)
  {
    ...
    target.values[1] <- c(Z1_c[,i], Z1_id[,i], Z1_g[,i], Z1_rex[,i], Z1_imp[,i], Z2_M_TOT_int[,i], Z1_M_TOT_int[,i], 
                          sum(Z1_d[,i]), Z1_va[,i], sum(x[1 : 5,i]), Z1_gdef[,i], Z1_b_s[,i] / Z1_va[,i], Z1_b_s[, i])[target.indices]
    target.values[2] <- c(Z2_c[,i], Z2_id[,i], Z2_g[,i], Z2_rex[,i], 
